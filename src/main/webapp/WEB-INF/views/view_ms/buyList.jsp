...
<!--------------------------------------leftsidebar------------------------------------->
		...
		<main class="content">
			<h1 class="text-center"><a href="#">구매 리스트</a></h1><br><br>
			<div class="block">
				<table>
					<thead>
						<tr>
					...
					<tbody>
						<c:forEach var="Payment" items="${Payment}">
							<tr>
								...
								<td><a href="/view_ms/buyListDetail?sell_num=${Payment.sell_num}">${Payment.sell_num}</a></td>
								<td>${Payment.approval_num}</td>
			...
			<a href="/view_ms/hoogiList"><button type="button">내가 쓴 후기</button></a>
		</main>
<!------------------------------------- right-sidebar --------------------------------------->
