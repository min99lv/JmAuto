...
<!--------------------------------------leftsidebar------------------------------------->
		<main class="content">
			<h1 class="text-center"><a href="#">차량구매 상세페이지</a></h1><br><br>
			<div class="block">
				<h2>중고차 구매 후기 작성</h2>
				<br>
				<br>
				<form action="/hoogiwrite" method="POST">
					<label for="carModel">매물 번호:</label> 
					
					<input type="text" value="${sell_num}" id="carModel" name="sell_num" required> 
					...
					<label for="rating">평점:<select id="evaluation" name="evaluation" required></label><br>
