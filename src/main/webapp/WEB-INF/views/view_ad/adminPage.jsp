		...
		<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
			...
			<script>
				...
				function searchUsers() {
					...
					// 서버에 검색 요청을 보냄
					$.ajax({
						url: '/view_ad/searchUser',  // 서버의 검색 처리 URL
						type: 'GET',
				...
				<div class="manager_container">
					<div class="manager_gogi">
						...
						<div class="manager_header">
							...
							<div class="searchBox">
								<input id="search_input" name="keyword" placeholder="아이디 또는 이름 입력">
								<button id="search_btn" onclick="searchUsers()">검색</button>
							</div>
									...
									<tbody>
										<c:forEach var="users" items="${userList }">
											<tr>
												...
												<td>${users.user_email }</td>
												<td>
													<fmt:formatDate value="${users.user_regdate}"
														pattern="yyyy. MM. dd." />
												</td>
												<td>
													<button class="but_background"
														onclick="userActive('${users.user_id }')"><img alt="노출_icon"
															src="<%=request.getContextPath()%>/images/main/노출_icon.png"
															class="but_images"></button>
													<button class="but_background"
														onclick="userDeactive('${users.user_id }')"><img alt="삭제_icon"
